...
- Schreibe professionelles Deutsch. Halte den Text auf maximal 2 Sätze. Keine Füllsätze — VERBOTEN: "reibungslosen Übergang", "stehen wir Ihnen zur Verfügung", "selbstverständlich", "alles in unserer Kraft Stehende", "bei der Suche unterstützen". Nur das Wesentliche: Kündigung + Datum + Grund + Abschluss. Beispiel: "wir bedauern Ihnen mitteilen zu müssen, dass wir den bestehenden Pflegevertrag zum [Datum] aufgrund von [Grund] kündigen müssen. Wir entschuldigen uns für die Unannehmlichkeiten und wünschen Ihnen weiterhin alles Gute."
